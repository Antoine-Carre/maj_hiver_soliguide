...
if categorie_2 == 'Structures':
    ...
    if df_fiches_màj_pie['A jour'].empty:
        ...
        # Nbre de fiches màj par jour
            ...
            fig3ter = go.Figure(data=[go.Pie(labels=df_source_màj_2['❄️ Source de la mise à jour'], values=df_source_màj_2.index)],title="Comment l'équipe a obtenu les informations ?")
